...
export default function HookedSearch() {
    ...
    return (
        <div className="flex flex-col h-screen">
            {/* Header */}
            <div className="h-16 px-4 flex-none flex items-center justify-end text-gray-100 bg-gradient-to-r from-gray-400 to-gray-800 shadow-md">
                <h1 className="text-2xl uppercase">Giffy Search</h1>
            </div>

            <div className="container overflow-hidden flex-auto max-w-md mx-auto flex flex-col">
                {/* Search form */}
                <form
                    className="mt-4 flex-none flex flex-col"
                ...
                {/* Search results */}
                <div className="mt-4 flex-auto overflow-y-auto smallscroll">
                    {loading
                        ? 'Loading'
